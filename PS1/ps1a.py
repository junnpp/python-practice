...
def compare_cow_transport_algorithms():
    ...
    for i in greedy_list:
        if min_trip == None or len(i) < min_trip:
            min_trip = len(i)

    print("Greedy algorithm takes ", start - end, " seconds with the minimum number of trips: ", min_trip)
    ...
    print("Brute force algorithm takes ", start - end, " seconds with the minimum number of trips: ", min_trip)
